...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-25 08:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0e6abe28-1cd6-4b03-b8eb-8c65c19a358c.git
$ cd 0e6abe28-1cd6-4b03-b8eb-8c65c19a358c
```
